      ...
      >
        ...
        {role === 'consumidor' && (
          <>
            ...
            {/* Formulario del consumidor */}
            <View style={styles.form}>
              {/* Campos del consumidor */}
              <TextInput label="Nombre Completo" value={formData.nombre} onChangeText={text => updateFormData('nombre', text)} mode="outlined" style={styles.input} outlineColor={roleColors.consumidor.primary} activeOutlineColor={roleColors.consumidor.primary} error={!!errors.nombre} />
              {errors.nombre && <HelperText type="error">{errors.nombre}</HelperText>}
              <TextInput label="Cédula" value={formData.cedula} onChangeText={text => updateFormData('cedula', text)} mode="outlined" style={styles.input} outlineColor={roleColors.consumidor.primary} activeOutlineColor={roleColors.consumidor.primary} error={!!errors.cedula} />
              {errors.cedula && <HelperText type="error">{errors.cedula}</HelperText>}
              <TextInput label="Teléfono/WhatsApp" value={formData.telefono} onChangeText={text => updateFormData('telefono', text)} mode="outlined" style={styles.input} outlineColor={roleColors.consumidor.primary} activeOutlineColor={roleColors.consumidor.primary} error={!!errors.telefono} />
              {errors.telefono && <HelperText type="error">{errors.telefono}</HelperText>}
              <TextInput label="Correo" value={formData.email} onChangeText={text => updateFormData('email', text)} mode="outlined" style={styles.input} outlineColor={roleColors.consumidor.primary} activeOutlineColor={roleColors.consumidor.primary} error={!!errors.email} />
              {errors.email && <HelperText type="error">{errors.email}</HelperText>}
              <TextInput label="Contraseña" value={formData.password} onChangeText={text => updateFormData('password', text)} mode="outlined" secureTextEntry={!showPassword} style={styles.input} outlineColor={roleColors.consumidor.primary} activeOutlineColor={roleColors.consumidor.primary} error={!!errors.password} right={<TextInput.Icon icon={showPassword ? "eye-off" : "eye"} onPress={() => setShowPassword(!showPassword)} />} />
              {errors.password && <HelperText type="error">{errors.password}</HelperText>}
              <TextInput label="Confirmar Contraseña" value={formData.confirmPassword} onChangeText={text => updateFormData('confirmPassword', text)} mode="outlined" secureTextEntry={!showConfirmPassword} style={styles.input} outlineColor={roleColors.consumidor.primary} activeOutlineColor={roleColors.consumidor.primary} error={!!errors.confirmPassword} right={<TextInput.Icon icon={showConfirmPassword ? "eye-off" : "eye"} onPress={() => setShowConfirmPassword(!showConfirmPassword)} />} />
              {errors.confirmPassword && <HelperText type="error">{errors.confirmPassword}</HelperText>}
              <Button mode="contained" style={[styles.registerButton, { backgroundColor: roleColors.consumidor.primary }]} onPress={handleRegister}>Registrarse</Button>
            </View>
          </>
        )}
